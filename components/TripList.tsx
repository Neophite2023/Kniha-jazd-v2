        ...
        <div className="space-y-3">
          {trips.map((trip) => (
            <div
              ...
              className={`bg-white dark:bg-[#2a2a2d] rounded-3xl overflow-hidden border transition-all duration-700 ${highlightedTripId === trip.id ? 'border-zinc-900 dark:border-white ring-4 ring-zinc-900/10 dark:ring-white/10 scale-[1.02] shadow-xl z-10' : 'border-zinc-200 dark:border-[#333336]/50 shadow-sm'}`}
            >
              <div
                className={`group relative p-4 flex justify-between items-center active:bg-zinc-50 dark:active:bg-[#242427] transition-colors ${highlightedTripId === trip.id ? 'bg-zinc-50/50 dark:bg-[#242427]/50' : ''}`}
              >
