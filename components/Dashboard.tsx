...
const Dashboard: React.FC<DashboardProps> = ({
  ...
  return (
    <div className="space-y-4 animate-in fade-in duration-500">
        ...
        <div className="absolute top-5 right-5 z-10">
          {settings.cars.length > 1 && (
            <select
              ...
              className="bg-zinc-100 dark:bg-zinc-800 text-zinc-900 dark:text-zinc-100 text-[10px] font-bold uppercase tracking-wide py-1.5 px-3 rounded-full outline-none border-none cursor-pointer hover:bg-zinc-200 dark:hover:bg-zinc-700 transition-colors appearance-none"
      ...
      {activeTrip && (
        <div className="bg-white dark:bg-zinc-800 rounded-3xl p-4 flex items-center justify-between shadow-xl ring-1 ring-zinc-200 dark:ring-white/10">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 bg-zinc-900 dark:bg-white text-white dark:text-zinc-950 rounded-2xl flex items-center justify-center">
