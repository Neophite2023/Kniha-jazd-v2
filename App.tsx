...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#313134] flex flex-col text-zinc-50 selection:bg-zinc-500/30 antialiased overflow-x-hidden relative transition-colors duration-300">
              ...
              <div className="bg-[#3f3f42] rounded-3xl p-6 border border-[#4d4d50]/50 shadow-sm space-y-6">
                ...
                <div className="space-y-4">
                  <div className="flex gap-4">
                    <div className="w-10 h-10 bg-[#38383b] rounded-xl flex items-center justify-center text-zinc-100 shrink-0">
                  ...
                  <div className="flex gap-4">
                    <div className="w-10 h-10 bg-white dark:bg-zinc-800 rounded-xl flex items-center justify-center text-[#313134] dark:text-zinc-100 shrink-0">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      <h4 className="font-bold text-[#313134] dark:text-zinc-100">Export dát do CSV</h4>
                      <p className="text-xs text-zinc-300">Exportujte všetky jazdy vybraného auta do formátu CSV (Excel) jediným kliknutím priamo z nastavení auta.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      <h4 className="font-bold text-[#313134] dark:text-zinc-100">GPS Sledovanie</h4>
                      <p className="text-xs text-zinc-300">Aplikácia pri každej jazde automaticky zaznamenáva štartovacie a cieľové GPS súradnice pre presnú evidenciu trasy.</p>
                    </div>
                  </div>
                ...
                <div className="pt-4 border-t border-zinc-200 dark:border-zinc-800">
                  <button
                    ...
                    className="w-full py-3 bg-[#313134] text-white rounded-2xl font-bold text-sm transition-all active:scale-[0.98] border border-[#4d4d50]/50"
                  >
                    Rozumiem
                  </button>
                </div>
      ...
      <nav className="fixed bottom-0 left-0 right-0 z-50 bg-[#313134]/80 backdrop-blur-3xl border-t border-[#4d4d50]/50 pb-[env(safe-area-inset-bottom)]">
