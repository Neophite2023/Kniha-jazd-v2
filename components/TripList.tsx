    ...
    <div className="space-y-6 pb-24 animate-in fade-in duration-500">
      {trips.length === 0 ? (
        <div className="text-center py-40">
          <p className="text-zinc-300 font-medium text-sm">Žiadne záznamy v archíve</p>
        </div>
      ) : (
              ...
              >
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-[10px] font-medium text-zinc-300 uppercase tracking-wide">
                    ...
                    {(trip.startGps || trip.endGps) && (
                      <div className="text-[9px] font-medium text-zinc-300 tabular-nums mt-0.5">
                ...
                <div className="flex items-center gap-4">
                  <div className="text-right">
                    ...
                    <div className="text-[10px] font-medium text-zinc-300 uppercase tabular-nums">{trip.endOdometer} km</div>
                  </div>
                  <button
